...
public class ParrotTest {
    ...
    public void getSpeedOfEuropeanParrot() {
        Parrot parrot = new EuropeanParrot(ParrotTypeEnum.EUROPEAN, 0, false);
    ...
    public void createAfricanParrotWithLessOneCoconut() {
    	AfricanParrot parrot = new AfricanParrot(ParrotTypeEnum.AFRICAN, 0);
    	parrot.setNumberOfCoconuts(-1);
    }

    @Test
    public void getSpeedNorwegianBlueParrot_nailed() {
        Parrot parrot = new NorwegianBlueParrot(ParrotTypeEnum.NORWEGIAN_BLUE, 0 ,true);
        assertEquals(parrot.getSpeed(), 0.0, 0.0);
    }
